var Victoire = function(monCanvas, _target, data_interface){
  var self = this;
  ...
  Object.keys(data_interface.elements).forEach(function(key) {
      ...
      if(data_interface.elements[key].nature == "text"){
          self[key] = new Text_affichage(monCanvas, data_interface.elements[key], key, data_interface.maxWidth_text, data_interface.lineHeight, _target.data_texte.victoire, data_interface.elements[key].reference=="" ? "" : data_interface.elements[data_interface.elements[key][reference]]);
